    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            ...
            min-height: 100vh; padding: 30px; line-height: 1.6; color: #1a1a1a;
        }
        .container { max-width: 1400px; margin: 0 auto; background: #ffffff; border-radius: 20px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.08); overflow: hidden; }
        .header { background: linear-gradient(135deg, #4299e1 0%, #667eea 100%); color: #ffffff; padding: 60px 50px; text-align: center; border-radius: 30px 30px 0 0; }
        .header h1 { font-size: 3.2em; font-weight: 300; margin-bottom: 16px; letter-spacing: -1px; }
        .header .date { font-size: 1.2em; opacity: 0.8; font-weight: 300; letter-spacing: 0.5px; }
        .content { padding: 40px; }
        .topics-grid, .users-grid {
            display: grid;
        ...
        .full-width-section { grid-column: 1 / -1; margin-bottom: 40px; }
        .section-title { font-size: 1.6em; font-weight: 600; margin-bottom: 25px; color: #4a5568; letter-spacing: -0.3px; display: flex; align-items: center; gap: 10px; border-bottom: 2px solid #e2e8f0; padding-bottom: 10px; }
        .stats-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 25px; margin-bottom: 40px; }
        .stat-card { background: linear-gradient(135deg, #f7fafc 0%, #edf2f7 100%); padding: 40px 30px; text-align: center; border-radius: 25px; border: 1px solid #e2e8f0; transition: all 0.3s ease; }
        ...
        .stat-number { font-size: 3.2em; font-weight: 300; color: #4299e1; margin-bottom: 10px; display: block; letter-spacing: -1px; }
        .stat-label { font-size: 1em; color: #666666; font-weight: 400; text-transform: uppercase; letter-spacing: 1px; }
        .active-period { background: linear-gradient(135deg, #4299e1 0%, #667eea 100%); color: #ffffff; padding: 40px; text-align: center; margin: 60px 0; border-radius: 25px; box-shadow: 0 8px 24px rgba(66, 153, 225, 0.3); }
        .active-period .time { font-size: 3.2em; font-weight: 200; margin-bottom: 10px; letter-spacing: -1px; }
        .active-period .label { font-size: 1em; opacity: 0.8; font-weight: 300; text-transform: uppercase; letter-spacing: 1px; }
        .topic-item {
            background: #ffffff;
            padding: 25px;
            margin-bottom: 0;
        ...
        .topic-number { background: linear-gradient(135deg, #3182ce 0%, #2c5282 100%); color: #ffffff; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 500; margin-right: 16px; font-size: 1em; box-shadow: 0 4px 12px rgba(49, 130, 206, 0.3); }
        .topic-title { font-weight: 600; color: #2d3748; font-size: 1.3em; letter-spacing: -0.3px; }
        .topic-contributors { color: #666666; font-size: 1em; margin-bottom: 16px; text-transform: uppercase; letter-spacing: 0.5px; }
        .topic-detail { color: #333333; line-height: 1.6; font-size: 1em; font-weight: 300; }
        .user-title {
            background: #ffffff;
            padding: 20px;
            margin-bottom: 0;
        ...
        .user-avatar { width: 50px; height: 50px; border-radius: 50%; margin-right: 20px; border: 2px solid #f0f0f0; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); }
        .user-avatar-placeholder { width: 50px; height: 50px; border-radius: 50%; background: linear-gradient(135deg, #f0f0f0 0%, #e2e8f0 100%); display: flex; align-items: center; justify-content: center; margin-right: 20px; font-size: 1.2em; color: #999999; border: 2px solid #e5e5e5; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); }
        .user-details { flex: 1; }
        .user-name { font-weight: 600; color: #2d3748; margin-bottom: 15px; font-size: 1.2em; letter-spacing: -0.2px; }
        .user-badges {
            display: flex;
            align-items: center;
            gap: 15px;
        ...
        .user-title-badge, .user-mbti {
            white-space: nowrap;
            display: inline-flex;
            align-items: center;
        }
        .user-title-badge { background: linear-gradient(135deg, #4299e1 0%, #3182ce 100%); color: #ffffff; padding: 8px 20px; border-radius: 25px; font-size: 0.9em; font-weight: 500; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 2px 8px rgba(66, 153, 225, 0.3); }
        .user-mbti { background: linear-gradient(135deg, #667eea 0%, #5a67d8 100%); color: #ffffff; padding: 8px 15px; border-radius: 20px; font-weight: 500; font-size: 0.9em; text-transform: uppercase; letter-spacing: 1px; box-shadow: 0 2px 8px rgba(102, 126, 234, 0.3); }
        .user-reason { color: #666666; font-size: 1em; text-align: right; line-height: 1.4; font-weight: 300; margin-left: 20px; flex: 1; word-wrap: break-word; overflow-wrap: break-word; }
        ...
        .footer { background: linear-gradient(135deg, #3182ce 0%, #2c5282 100%); color: #ffffff; text-align: center; padding: 40px; font-size: 1em; font-weight: 300; letter-spacing: 0.5px; opacity: 0.9; }
        ...
        @media (min-width: 1400px) { .container { max-width: 1600px; } .topics-grid { grid-template-columns: repeat(3, 1fr); } .users-grid { grid-template-columns: repeat(3, 1fr); } }
        @media (max-width: 768px) { body { padding: 15px; } .container { margin: 0; max-width: 100%; } .header { padding: 30px 25px; } .header h1 { font-size: 2.2em; } .content { padding: 25px; } .topics-grid { grid-template-columns: 1fr; } .users-grid { grid-template-columns: 1fr; } .stats-grid { grid-template-columns: 1fr 1fr; gap: 15px; } .stat-card { padding: 25px 20px; } .topic-item { padding: 25px; } .user-title { flex-direction: column; align-items: flex-start; gap: 15px; padding: 20px; min-height: auto; } .user-info { width: 100%; } .user-reason { text-align: left; max-width: none; margin-left: 0; margin-top: 10px; } }
    </style>
</head>
<body>
    <div class="container">
